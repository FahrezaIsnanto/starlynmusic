  ...
  return (
    <Layout>
      <div className="contentStart">
        <img src="/images/music.png" className="contentStartImg" alt="music"></img>
        <Input label="Nomor Rekam Medis" placeholder="Masukkan nomor rekam medis" onChange={handleChangeRekamMedis} />
        <Gap height={15} />
        <Input label="Tanggal Lahir" placeholder="Masukkan tanggal lahir d-m-Y" onChange={handleChangeTglLahir} />
        <Gap height={30} />
